...
import creditcard.model.ChargeTransaction;
...
public class ChargeFrame implements Frame
{
    private final Database<CreditCardAccount> database;
    private final JFrame jFrame;
    String accountNumber;

    public ChargeFrame(Database<CreditCardAccount> database,String accountNumber)
    {
    ...
    private JFrame getFrame()
    {
        ...
        jFrame.setTitle("Charge");
        jFrame.getContentPane().setLayout(null);
        jFrame.setSize(300,200);
        jFrame.setVisible(false);
        JLabel1.setText("Credit Cardss Nr");
        jFrame.getContentPane().add(JLabel1);
        JLabel1.setForeground(java.awt.Color.black);
        JLabel1.setBounds(12,12,48,24);
        JLabel2.setText("Charge Amount");
...
//        fincoFramework.view.DepositFrame.SymAction lSymAction = new fincoFramework.view.DepositFrame.SymAction();
    ...
    void onOkButtonPressed()
    {
        ...
        database.getAccount(accountNumber).addTransaction(new ChargeTransaction("walmart",amount, Utils.getCurrentTime()));
